    ...
    static let reducer = Reducer<State, Action, Environment> { state, action, environment in
        ...
        case .startInitialize:
            ...
            return NftClient.shared.caller()
                ...
                .catchToEffect()
                .map(MultiTokenListVM.Action.endInitialize)
        ...
        case .startRefresh:
            ...
            return NftClient.shared.caller()
                ...
                .receive(on: environment.mainQueue)
                .catchToEffect()
                .map(MultiTokenListVM.Action.endRefresh)
        ...
        case .startNext:
            ...
            return NftClient.shared.caller()
                ...
                .receive(on: environment.mainQueue)
                .catchToEffect()
                .map(MultiTokenListVM.Action.endNext)
